...
class AssessmentFormValidationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.module = Module.objects.create(
            ...
            module_name="Validation Test Module",
            credits=20
        )

    def test_maximum_score_can_be_blank_without_raw_score(self):
        form = AssessmentForm(
            data={
                "module": self.module.id,
                "assessment_name": "Coursework 1",
    ...
    def test_raw_score_requires_maximum_score(self):
        form = AssessmentForm(
            data={
                "module": self.module.id,
                "assessment_name": "Coursework 1",
        ...
        self.assertFalse(form.is_valid())
        self.assertIn("maximum_score", form.errors)

    def test_raw_score_cannot_exceed_maximum_score(self):
        form = AssessmentForm(
            data={
                "module": self.module.id,
                "assessment_name": "Coursework 1",
        ...
        self.assertFalse(form.is_valid())
        self.assertIn("raw_score", form.errors)

    def test_raw_score_sets_status_to_graded(self):
        form = AssessmentForm(
            data={
                "module": self.module.id,
                "assessment_name": "Coursework 1",
    ...
    def test_graded_status_requires_raw_score(self):
        form = AssessmentForm(
            data={
                "module": self.module.id,
                "assessment_name": "Coursework 1",
